...
![](media/image1.png){width="6.4998611111111115in"
...
white is decoration).
  ...
  ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  ![](media/image2.png){width="1.318056649168854in" height="1.3562510936132983in"}   ![](media/image3.png){width="1.7270833333333333in" height="1.7576399825021873in"}   ![](media/image4.png){width="2.0229166666666667in" height="2.0076399825021873in"}
  ---------------------------------------------------------------------------------- ----------------------------------------------------------------------------------- -----------------------------------------------------------------------------------
...
### Examples
  ...
  **Input**   **Output**                 **Explanation**
  ----------- -------------------------- ---------------------------------------------------------------------------------------------
  11,         Stone required: 124        Total **stone** is 81\*0.75+49\*0.75+25\*0.75+9\*0.75+1\*0.75 = 123.75, we round up to 124.
                                         
  0.75        Marble required: 84        Total **marble** is 40\*0.75+32\*0.75+24\*0.75+16\*0.75=84.
                                         
              Lapis Lazuli required: 6   Total **lapis lazuli** is 8\*0.75=6.
                                         
              Gold required: 1           Total **gold** is 1\*0.75=0.75, we round up to 1.
                                         
              Final pyramid height: 4    Total **height** is 4.5 (6 **steps** times 0.75), we round down to 4.
  ------------------------------------------------------------------------------------------------------------------------------------
  ...
  **Input**   **Output**                     **Input**   **Output**
  ...
  1           Marble required: 128           0.5         Marble required: 228
              ...
              Lapis Lazuli required: 12                  Lapis Lazuli required: 36
...
examples.
  ...
  **Input**     **Output**                    **Input**                        **Output**
  ------------- -------------------------- -- -------------------------------- ---------------------------------------
  \[50, 100\]   Bought bitcoins: 0            \[3124.15, 504.212, 2511.124\]   Bought bitcoins: 30
                                                                               
                Money left: 10126.50 lv.                                       Day of the first purchased bitcoin: 1
